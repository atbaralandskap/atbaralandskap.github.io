...
topo_path <- "C:/Users/henri/data/topologi10/mark_sverige.gpkg"

sormland_res <- analyse_region_landuse(
  src_path  = topo_path,
  src_layer = "mark",
  region    = "Södermanland",   # eller "2584"
  buffer_km = 0,
  value     = "pct_area"
)
...
```{r}
mapview_landuse_res(sormland_res, "objekttyp")
```
